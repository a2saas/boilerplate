  ...
  return (
    <div className="space-y-24 py-12">
      ...
      <section className="space-y-6 text-center">
        <h1 className="font-heading max-w-2xl  mx-auto text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-5xl">
          Built for AI Agents{" "}
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row my-8">
