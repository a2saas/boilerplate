...
function TerminalWindow({
  ...
  return (
    <div className="hidden sm:block w-56 shrink-0 self-start translate-y-4 overflow-hidden rounded-lg border border-zinc-800 bg-zinc-950 shadow-xl dark:shadow-[0_8px_30px_rgba(180,140,50,0.15)]">
...
export default function Home() {
  return (
    <div className="space-y-24">
      {/* Hero Section */}
      <section className="space-y-8 py-12 text-center sm:py-24">
      ...
      {/* Template Notice */}
      <section>
        <div className="rounded-lg border border-dashed border-zinc-300 bg-muted px-6 py-4 text-center dark:border-zinc-700 dark:bg-zinc-900">
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            This is the {siteConfig.name} template landing page. Replace this
            page with your own content when you&apos;re ready to launch.
          </p>
        </div>
      </section>
    </div>
